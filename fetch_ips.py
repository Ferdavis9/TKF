...
# Update url: https://github.moeyy.xyz/https://raw.githubusercontent.com/Ferdavis9/GitHub520/main/hosts
...
def get_json(session: Any) -> Optional[list]:
    url = 'https://raw.githubusercontent.com/Ferdavis9/GitHub520/main/hosts.json'
    try:
        rs = session.get(url)
